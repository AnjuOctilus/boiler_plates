...
class CreatePostcodeLookupResultTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('postcode_lookup_result', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('postcode_lookup_result');
    }
}
